          ...
          children: [
            ...
            Container(
              ...
              child: ListTile(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                        "By continuing, you agree to Zrnara's"),
                                    Text(
                                      "Terms & ",
                                      style: TextStyle(
                                        color: Color(0xFF795548),
                ...
                subtitle: Text(
                  "Login/Signup to managenyour Orders and a lot more",
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage: AssetImage("assets/profile_pages/order.png"),
                ),
                title: Text(
                  "My orders",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                ...
                subtitle: Text(
                  "Track, cancel and return ordres",
                  style: TextStyle(color: Colors.black),
                ),
                trailing: IconButton(
                  onPressed: () {},
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage:
                      AssetImage("assets/profile_pages/whishlist.png"),
                ),
                title: Text(
                  "My Whishlist",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage:
                      AssetImage("assets/profile_pages/address.png"),
                ),
                title: Text(
                  "My Addresses",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                ...
                subtitle: Text(
                  "Save addresses for faster check out",
                  style: TextStyle(color: Colors.black),
                ),
                trailing: IconButton(
                  onPressed: () {},
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage:
                      AssetImage("assets/profile_pages/custommer service.png"),
                ),
                title: Text(
                  "Customer Support",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                ...
                subtitle: Text(
                  "Help regarding your purchases",
                  style: TextStyle(color: Colors.black),
                ),
                trailing: IconButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CustommerSupportScreen()));
                  },
                  icon: Icon(
                    Icons.arrow_forward_ios_sharp,
                    color: Color(0xFF795548),
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage: AssetImage("assets/profile_pages/bank.png"),
                ),
                title: Text(
                  "Add bank details",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage: AssetImage("assets/profile_pages/rate.png"),
                ),
                title: Text(
                  "Rate Us",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage: AssetImage("assets/profile_pages/about.png"),
                ),
                subtitle: Text(
                  "Explore our purpose",
                  style: TextStyle(color: Colors.black),
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage: AssetImage("assets/profile_pages/terms.png"),
                ),
                title: Text(
                  "Terms & Conditions",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage:
                      AssetImage("assets/profile_pages/privacy.png"),
                ),
                title: Text(
                  "Privacy Policy",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
            ...
            Container(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage:
                      AssetImage("assets/profile_pages/feedback.png"),
                ),
                title: Text(
                  "Feedback",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
